...
//  watch providers, trailers, genres, and cast (guest stars) where identical.
//
...
extension TMDBWrapper {
    ...
    struct EpisodeRaw: Codable {
        ...
        func episode() -> Episode {
            ...
            // Directors first, then the rest, so `MovieCastSection` surfaces them on top.
...
// MARK: - Shared watch-provider mapping
